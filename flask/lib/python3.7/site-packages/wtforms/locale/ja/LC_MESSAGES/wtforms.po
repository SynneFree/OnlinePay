...
msgstr "无効な値です, 次のうちの１つでなければいけません: %(values)s."

#: wtforms/validators.py:514
#, python-format
msgid "Invalid value, can't be any of: %(values)s."
msgstr "无効な値です、次に含まれるものは使えません: %(values)s."
